...
require (
	...
	github.com/hertz-contrib/registry/zookeeper v0.0.0-20250319055937-8a220332e808 // indirect
	...
	github.com/kitex-contrib/registry-zookeeper v0.0.0-20240813065530-bfdecef3f6bd // indirect
