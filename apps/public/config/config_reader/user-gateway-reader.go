...
func setDefaultForUserGatewayGateway(v *viper.Viper) {
	...
	v.SetDefault(config_template.USER_GATEWAY_ETCD_NAMESPACE, "middleware")
	v.SetDefault(config_template.USER_GATEWAY_LOKI_NAMESPACE, "middleware")
	...
	v.SetDefault(config_template.USER_GATEWAY_REDIS_NAMESPACE, "dao")
