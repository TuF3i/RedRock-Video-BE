...
func setDefaultForVideoRpc(v *viper.Viper) {
	...
	v.SetDefault(config_template.VIDEO_RPC_REDIS_PASSWORD, "eeelcgkklo12l13l17gg")
	...
	v.SetDefault(config_template.VIDEO_RPC_MINIO_ACCESSKEY, "sddadmin")
	v.SetDefault(config_template.VIDEO_RPC_MINIO_SECRETKEY, "eeelcgkklo12l13l17gg")
	...
	v.SetDefault(config_template.VIDEO_RPC_PGSQL_PASSWORD, "eeelcgkklo12l13l17gg")
