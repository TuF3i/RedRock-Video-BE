...
func (r *Dao) checkIfDanmuExistOnRedis(ctx context.Context, data *models.DanmuData) (bool, error) {
...
func (r *Dao) insertDanmuToRedis(ctx context.Context, data *models.DanmuData) error {
