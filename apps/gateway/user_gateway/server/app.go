...
func onCreate() {
	...
	l.Info("Starting UserGatewayNode...")

	// 初始化配置文件
	conf, err := config.LoadUserGatewayConfig()
	if err != nil {
	...
	l.Info("Starting UserGatewayNode Successfully!")
}

func onDestroy() {
	l.Modular = "user-gateway-on-destroy"
	l.Info("Shutdown UserGatewayNode...")
