...
func SendLiveOff(roomID int64) error {
	return GetManager().closeRoom(roomID)
}
...
func (m *WebSocketManager) closeRoom(roomID int64) error {
	m.mu.RLock()
	room, ok := m.rooms[roomID]
	m.mu.RUnlock()
