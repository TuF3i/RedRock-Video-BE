...
func (r *Dao) newField(ctx context.Context, key string, field string, data *models.VideoInfo) error {
	// 序列化
...
// TODO 抄过来
func (r *Dao) getFields(ctx context.Context, key string, page int32, pageSize int32) ([]*models.VideoInfo, int64, error) {
...
func (r *Dao) getFieldDetail(ctx context.Context, key string, field string) (*models.VideoInfo, error) {
