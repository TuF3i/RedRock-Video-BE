...
func convertAtoB(data *models.VideoInfo) *videosvr.VideoDetail {
...
func convertC2D(data *models.VideoInfo) *videosvr.VideoListData {
...
func batchDaoToVideoDetail(dataSet []*models.VideoInfo) []*videosvr.VideoDetail {
...
func batchDaoToVideoListData(dataSet []*models.VideoInfo) []*videosvr.VideoListData {
