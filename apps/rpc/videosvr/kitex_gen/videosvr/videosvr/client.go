...
type Client interface {
	...
	GetVideoList(ctx context.Context, req *videosvr.GetPreSignedUrlReq, callOptions ...callopt.Option) (r *videosvr.GetVideoListResp, err error)
...
func (p *kVideoSvrClient) GetVideoList(ctx context.Context, req *videosvr.GetPreSignedUrlReq, callOptions ...callopt.Option) (r *videosvr.GetVideoListResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
