...
func convertDao2LiveListInfo(raw *models.LiveInfo) *livesvr.LiveListInfo {
...
func batchA2B(raw []*models.LiveInfo) []*livesvr.LiveListInfo {
...
func batchC2D(raw []*models.LiveInfo) []*livesvr.LiveDetail {
