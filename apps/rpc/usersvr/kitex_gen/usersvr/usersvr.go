...
var RvUserInfo_Bio_DEFAULT string

func (p *RvUserInfo) GetBio() (v string) {
	if !p.IsSetBio() {
		return RvUserInfo_Bio_DEFAULT
	}
	return *p.Bio
}

var RvUserInfo_Role_DEFAULT string

func (p *RvUserInfo) GetRole() (v string) {
	if !p.IsSetRole() {
		return RvUserInfo_Role_DEFAULT
	}
	return *p.Role
}
...
func (p *RvUserInfo) IsSetBio() bool {
	return p.Bio != nil
}

func (p *RvUserInfo) IsSetRole() bool {
	return p.Role != nil
}
