...
func (r *Dao) AddUser(data *models.RvUser) error {
	uid := data.Uid
	tx := r.pgdb.Begin()
	// 查询用户是否存在
...
func (r *Dao) GetUserInfo(uid int64) (*models.RvUser, error) {
	tx := r.pgdb.Begin()
	defer tx.Rollback()
	// 获取用户信息
...
func (r *Dao) GetAdminerList(ctx context.Context, page int32, pageSize int32) ([]*models.RvUser, int64, error) {
	tx := r.pgdb.Begin()
	defer tx.Rollback()
...
func (r *Dao) GetUserList(ctx context.Context, page int32, pageSize int32) ([]*models.RvUser, int64, error) {
	tx := r.pgdb.Begin()
	defer tx.Rollback()
